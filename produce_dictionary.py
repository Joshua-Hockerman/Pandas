...
print(producet.loc[["Cherries", "Grapefruit"], "Total Sales"])
...
print(producet.loc[["Orange", "Beets"], ["Quantity Sold", "Total Sales"]])

print()
print("3. Using 'loc', display the total sales for 'Apples' through 'Lettuce'")

print(producet.loc["Apples":"Lettuce", ["Total Sales"]])
...
sorted_pro = producet.sort_values(by="Quantity Sold")

new_produce = sorted_pro.loc["Bok choy":"Cucumber"]
...
print(new_produce["Total Sales"])

total_produce_sales = new_produce["Total Sales"]

total_sales = 0
for i in range(len(total_produce_sales)):
    total_sales += total_produce_sales[i]

print("The sum of the total sales across the products is: ", total_sales)
